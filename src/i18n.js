...
const messages = {
    en: {
        ...
        'db.cartIdRequired': 'Cart ID is required.',
        'db.cartNotFound': 'Order history not found.',
        'db.deleteCartFail': 'Could not delete order history.',
        'db.deleteCartNotAllowed': 'You can only delete your own order history or ask an admin.',
